...
QT_MOC_LITERAL(1, 10, 13), // "state_changed"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 19), // "SSHClient::SSHState"
QT_MOC_LITERAL(4, 45, 9), // "connected"
QT_MOC_LITERAL(5, 55, 12) // "disconnected"

    },
    "SSHClient\0state_changed\0\0SSHClient::SSHState\0"
...
void SSHClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->state_changed((*reinterpret_cast< SSHClient::SSHState(*)>(_a[1]))); break;
        ...
        {
            typedef void (SSHClient::*_t)(SSHClient::SSHState );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SSHClient::state_changed)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SSHClient::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SSHClient::connected)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (SSHClient::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SSHClient::disconnected)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SSHClient::staticMetaObject = {
    { &QIODevice::staticMetaObject, qt_meta_stringdata_SSHClient.data,
      qt_meta_data_SSHClient,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void SSHClient::state_changed(SSHClient::SSHState _t1)
{
...
// SIGNAL 2
void SSHClient::disconnected(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
